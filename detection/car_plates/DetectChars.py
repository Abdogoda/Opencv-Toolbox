...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("detection/car_plates/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("detection/car_plates/flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
